...
const allQuizzes: QuizCard[] = [
  ...
  },
  {
    ...
    description: "Todo sobre el reciclaje de papel y cartón en el hogar y la oficina",
    difficulty: "easy",
  ...
  },
  {
    ...
    description: "Manejo responsable de dispositivos electrónicos al final de su vida útil",
    difficulty: "hard",
  ...
  },
  {
    ...
    description: "Aprende a crear compost en casa con residuos orgánicos",
    difficulty: "medium",
    category: "Orgánicos",
    imageUrl: "/composting-home.jpg",
    completed: false,
  ...
  },
  {
    ...
    description: "Proceso y beneficios del reciclaje de vidrio y cristal",
    difficulty: "easy",
    category: "Vidrio",
    imageUrl: "/glass-recycling.jpg",
    completed: false,
